...
class UpdateEmailUsecase implements UsecaseWithParams<ProfileEntity, String> {
  final IProfileRepository profileRepository;

  UpdateEmailUsecase(this.profileRepository);

  @override
  Future<Either<Failure, ProfileEntity>> call(String email) async {
    return await profileRepository.updateEmail(email: email);
  }
}
