...
class AddPhoneNumberUsecase
    implements UsecaseWithParams<ProfileEntity, String> {
  final IProfileRepository profileRepository;

  AddPhoneNumberUsecase(this.profileRepository);

  @override
  Future<Either<Failure, ProfileEntity>> call(String phoneNumber) async {
    return await profileRepository.addPhoneNumber(phoneNumber: phoneNumber);
  }
}
